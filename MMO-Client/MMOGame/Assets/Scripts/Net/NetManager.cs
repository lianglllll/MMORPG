...
{
    public NetClient m_loginGateClient = new NetClient();
    ...
    // loginGate
    public IEnumerator SendGetLoginGatesRequest(string uri)
    {
    ...
    private void _HandleGetGameGateTokenResponse(Connection sender, GetLoginGateTokenResponse message)
    {
        m_loginGateToken = message.LoginGateToken;
        Log.Debug($"以获取到loginToken:{m_loginGateToken}");
    }
