...
public class CommonListSelectOption : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler,IPointerClickHandler
{
    private Image Bg;
    private Text text;
    ...
    private int m_flag;
    private ICommonListSelectOpionMgr m_mgr;
    ...
    public void Init(ICommonListSelectOpionMgr mgr, string optionNames, int flag)
    {
        isClicked = false;
        isEntering = false;
        isExiting = false;
