...
namespace DBProxyServer.Utils
{
    ...
    public class AppConfig
    {
        ...
        public MongodbServerConfig mongodbServer { get; set; }
    ...
    public static class Config
    {
        ...
        public static MongodbServerConfig MongodbServerConfig => _config?.mongodbServer;
