...
namespace Common.Summer.Net
{
    ...
    public class LengthFieldDecoder_old
    {
        ...
        public LengthFieldDecoder_old(Socket socket, int maxBufferLength, int lengthFieldOffset,
        ...
        public void Start()
        {
            ...
            {
                m_isStart = true;
                m_Socket.BeginReceive(m_buffer, m_offect, m_size - m_offect, SocketFlags.None, new AsyncCallback(_OnReceive), null);
            }
        }
        ...
        private void _OnReceive(IAsyncResult result)
        {
            try
            {
                int len = 0;
