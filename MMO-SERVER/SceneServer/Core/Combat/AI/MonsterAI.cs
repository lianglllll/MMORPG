using SceneServer.Core.Combat.AI.FSM;
using SceneServer.Core.Combat.AI.FSM.State;
...
namespace SceneServer.Core.Combat.AI
{
    ...
    public class Param
    {
        public SceneMonster owner;          // AI拥有者
    ...
    public class MonsterAI : AIBase
    {
        ...
        public MonsterAI(SceneMonster owner) : base(owner)
        {
