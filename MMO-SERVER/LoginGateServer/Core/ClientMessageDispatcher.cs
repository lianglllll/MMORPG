...
namespace LoginGateServer.Core
{
    public class ClientMessageDispatcher : Singleton<ClientMessageDispatcher>
    {
        ...
        public void Init()
        {
            ProtoHelper.Register<Envelope>((int)LoginGateProtocl.Envelope);
            MessageRouter.Instance.Subscribe<Envelope>(_ProcessEnvelope);
        }
        public void UnInit()
        {
        ...
        private void _ProcessEnvelope(Connection sender, Envelope message)
        {
